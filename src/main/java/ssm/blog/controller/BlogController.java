...
public class BlogController {
    ...
    public ModelAndView details(@PathVariable("id") Integer id,
        ...
        Blog blog = blogService.findById(id); // 根据id获取文章
        ...
        blog.setClickHit(blog.getClickHit() + 1); // 将文章访问量加1
        blogService.update(blog); // 更新文章
    ...
    public ModelAndView search(
        ...
        int toIndex = blogIndexList.size() >= Integer.parseInt(page) * pageSize ? Integer
                ...
                : blogIndexList.size();
        modelAndView.addObject("blogIndexList",
